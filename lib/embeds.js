...
var self = module.exports = {
	...
	embedConstructor: function (type, options) {
		// NOTE: Alright before you say it I know this is inefficient
		//		 but I don't really want to write EmbedBuilder() every
		//		 time I want to create an embed so yeah
		//		 Might optimize and make this shorter in the future
		switch (type) {
			...
			case 'error': return {
				author: {
					...
					icon_url: `https://skiddledgithub.github.io/assets/bot/states/error.png`,
				},
				color: 0xF04A47,
			...
			case 'cooldown': return {
				author: {
					...
					icon_url: 'https://skiddledgithub.github.io/assets/bot/states/cooldown.png',
				},
				color: 0xFEE65C, 
			...
			case 'avatar': return {
      			author: {
      				...
      				icon_url: `https://skiddledgithub.github.io/assets/bot/commands/avatar.png`,
      			},
				color: 0x42B983,
      			image: {
      				url: `${options.image}`,
			...
			case 'banConfirmation': return {
				author: { 
					name: `Confirmation`, 
					icon_url: 'https://skiddledgithub.github.io/assets/bot/commands/ban.png',
				}, 
				color: 0xF04A47, 
			...
			case 'banCancel': return {
				author: { 
					...
					icon_url: 'https://skiddledgithub.github.io/assets/bot/states/cancelSaved.png',
				}, 
				color: 0x42B983, 
			...
			case 'banSuccess': return {
				author: { 
					...
					icon_url: 'https://skiddledgithub.github.io/assets/bot/states/confirmDeath.png',
				}, 
				color: 0xF04A47, 
			...
			case 'unbanSuccess': return {
				author: { 
					...
					icon_url: 'https://skiddledgithub.github.io/assets/bot/commands/unban.png',
				}, 
				color: 0x42B983, 
			...
			case 'kickConfirmation': return {
				author: { 
					name: `Confirmation`, 
					icon_url: 'https://skiddledgithub.github.io/assets/bot/commands/kick.png',
				}, 
				color: 0xF04A47, 
			...
			case 'evalFailed': return {
				author: {
					...
					icon_url: 'https://skiddledgithub.github.io/assets/bot/commands/evalFailed.png',
				},
				color: 0xF04A47,
			...
			case 'evalSuccess': return {
				author: {
					...
					icon_url: 'https://skiddledgithub.github.io/assets/bot/commands/eval.png',
				},
				color: 0x42B983,
			...
			case 'playSelection': return {
				author: {
					name: 'Search results',
					icon_url: 'https://skiddledgithub.github.io/assets/bot/commands/play.png',
				},
				color: 0x42B983,
			...
			case 'playAwait': return {
				author: {
					name: 'Hold on!',
					icon_url: 'https://skiddledgithub.github.io/assets/bot/commands/play.png',
				},
				color: 0x42B983,
				description: `Please wait while the bot process your query...`,
			};
			...
			case 'playUnavailable': return {
				author: {
					name: 'Video is unavailable',
					icon_url: 'https://skiddledgithub.github.io/assets/bot/states/error.png',
				},
				color: 0xF04A47,
				description: `Bot has left the VC because the video cannot be played. (Unavailable)`,
				fields: [
			...
			case 'stopSuccess': return {
				author: {
					name: 'Left VC',
					icon_url: 'https://skiddledgithub.github.io/assets/bot/commands/stop.png',
				},
				color: 0xF04A47,
			...
			case 'encodeSuccess': return {
				author: {
					...
					icon_url: 'https://skiddledgithub.github.io/assets/bot/commands/encode.png',
				},
				color: 0x42B983,
				description: 'Results:',
			...
			case 'about': return {
				author: {
					...
					icon_url: 'https://skiddledgithub.github.io/assets/bot/commands/about.png'
				},
				color: 0x3365E3,
				...
				fields: [
					...
					{ name: 'External Links', value: `>>> <:github:985088394470236160> [GitHub repository](https://github.com/ZenialDev/Cryotheum)\n<:bugReporter:965220811302637588> [Issue tracker](https://github.com/ZenialDev/Cryotheum/issues)\n<:botDev:965220811436855326> [Developer's solo.to](https://solo.to/zenial)` },
			...
			case 'stdoutSuccess': return {
				author: {
					...
					icon_url: 'https://skiddledgithub.github.io/assets/bot/commands/stdout.png',
				},
				color: 0x42B983,
		...
		if (!options.sBadges) {
			if (!options.iBadges) {
				return { 
					author: { 
						name: `User Profile`, 
						icon_url: 'https://skiddledgithub.github.io/assets/bot/commands/userinfo.png', 
					}, 
	...
	playResultsParser: function(results) {
		...
		results.forEach((item, index) => {
			if (item.type === 'video') {
				fields.push({ name: `${index + 1}. **${item.title}** by **${item.author.name}**`, value: `Length: ${item.duration}` })
			}
		});
