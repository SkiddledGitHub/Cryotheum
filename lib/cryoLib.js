		...
		switch (type) {
			...
			*/
			...
			case 'githubUserSuccess': return {
				...
				color: '#42B983',
				thumbnail: { url: options.user.avatarURL },
				description: options.user.bio,
				fields: options.user.data,
			}
	...
	log: function(type, message) {
		if (message.cause) {
			...
			switch (type) {
				...
				case 'runtimeErr': console.error(`\x1b[1;31m[Error > ${message.event} > ${message.errName}]\x1b[0;37m ${message.content}\x1b[0m`); break;
